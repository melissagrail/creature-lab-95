...
**Locomotion:** turns 360 degrees/s; strafe 82%; reverse 60%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
|---|---|---:|---|---|---|---|
| 1. Kindlebite | Melee | 19 | 6 / 3 / 9 | 27t / 90 | 1.76 / 0.78 | burn=30, move_start=55, move_active=55, move_recovery=60 |
| 2. Wickshot | Bolt | 14 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=430, burn=90, move_recovery=30 |
| 3. Flare Step | Lunge | 14 | 8 / 7 / 14 | 66t / 190 | 1.37 / 0.63 | speed=380, haste=45, move_recovery=25 |
| 4. Ash Circle | Field | 3 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | burn=45, lifetime=120, move_recovery=30, pulse every 24t |
...
**Locomotion:** turns 120 degrees/s; strafe 48%; reverse 35%; acceleration divisor 4; braking divisor 2; dodge speed 80%.
...
| 3. Bramble Garden | Field | 4 | 15 / 1 / 14 | 105t / 210 | 1.17 / 2.25 | lifetime=150, heal=2, move_recovery=30, pulse every 24t |
...
**Locomotion:** turns 150 degrees/s; strafe 55%; reverse 40%; acceleration divisor 3; braking divisor 1; dodge speed 85%.
...
**Locomotion:** turns 420 degrees/s; strafe 78%; reverse 52%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Spark Pin | Bolt | 11 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=430, mark=120, move_recovery=30 |
| 2. Arc Fang | Lunge | 18 | 8 / 7 / 14 | 66t / 190 | 1.37 / 0.63 | speed=380, bonus_mark=12, move_recovery=25 |
| 3. Discharge | Nova | 16 | 14 / 2 / 15 | 75t / 170 | 0.00 / 2.15 | bonus_mark=15, move_recovery=30 |
| 4. Static Screen | Ward | 0 | 3 / 1 / 9 | 120t / 160 | 0.00 / 0.00 | haste=45, shield=15, guard=24, move_recovery=30 |
...
**Locomotion:** turns 210 degrees/s; strafe 66%; reverse 48%; acceleration divisor 3; braking divisor 2; dodge speed 90%.
...
| 3. Mire Pool | Field | 2 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | lifetime=150, slow=30, poison=90, move_recovery=30, pulse every 24t |
...
**Locomotion:** turns 90 degrees/s; strafe 42%; reverse 28%; acceleration divisor 5; braking divisor 2; dodge speed 80%.
...
**Locomotion:** turns 480 degrees/s; strafe 95%; reverse 72%; acceleration divisor 2; braking divisor 1; dodge speed 115%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Icicle | Bolt | 16 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=500, slow=45, move_start=100, move_active=100, move_recovery=60 |
| 2. Snowshoe | Lunge | 12 | 8 / 5 / 8 | 66t / 190 | 1.37 / 0.63 | speed=430, slow=30, move_recovery=25 |
| 3. Frost Lace | Field | 2 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | lifetime=150, slow=45, move_start=65, move_active=65, move_recovery=60, pulse every 24t |
| 4. Whiteout | Nova | 17 | 14 / 2 / 15 | 75t / 170 | 0.00 / 2.73 | impulse=300, slow=60, move_recovery=30 |
...
**Locomotion:** turns 540 degrees/s; strafe 88%; reverse 65%; acceleration divisor 2; braking divisor 1; dodge speed 115%.
...
**Locomotion:** turns 240 degrees/s; strafe 80%; reverse 60%; acceleration divisor 3; braking divisor 1; dodge speed 95%.
...
**Locomotion:** turns 270 degrees/s; strafe 85%; reverse 62%; acceleration divisor 3; braking divisor 2; dodge speed 100%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Undertow | Beam | 18 | 18 / 1 / 17 | 66t / 190 | 7.81 / 0.27 | impulse=-700, slow=30, move_start=60, move_active=60, move_recovery=60 |
| 2. Tidal Bite | Melee | 23 | 6 / 3 / 9 | 27t / 90 | 1.76 / 0.78 | move_start=35, move_active=35, move_recovery=60 |
| 3. Rain Basin | Field | 3 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | lifetime=150, slow=20, heal=2, move_recovery=30, pulse every 24t |
| 4. Surge | Lunge | 14 | 8 / 7 / 14 | 66t / 190 | 1.37 / 0.63 | speed=380, haste=60, move_recovery=25 |
...
**Locomotion:** turns 360 degrees/s; strafe 85%; reverse 68%; acceleration divisor 2; braking divisor 1; dodge speed 105%.
...
**Locomotion:** turns 240 degrees/s; strafe 70%; reverse 50%; acceleration divisor 3; braking divisor 1; dodge speed 95%.
...
**Locomotion:** turns 180 degrees/s; strafe 58%; reverse 40%; acceleration divisor 4; braking divisor 2; dodge speed 90%.
...
**Locomotion:** turns 210 degrees/s; strafe 78%; reverse 50%; acceleration divisor 3; braking divisor 1; dodge speed 95%.
...
**Locomotion:** turns 450 degrees/s; strafe 85%; reverse 55%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
**Locomotion:** turns 120 degrees/s; strafe 50%; reverse 35%; acceleration divisor 4; braking divisor 2; dodge speed 80%.
...
| 3. Shelter Grove | Field | 2 | 15 / 1 / 14 | 105t / 210 | 2.54 / 2.34 | lifetime=150, heal=3, move_recovery=30, pulse every 24t |
...
**Locomotion:** turns 450 degrees/s; strafe 95%; reverse 65%; acceleration divisor 2; braking divisor 1; dodge speed 115%.

**Winning pattern:** Sweep the opponent off a line, reposition, send a fan into their exit.

**Counterplay:** Use terrain to shorten its strafe path and exploit its thin health pool.

**Learning test:** Learn different projectile leads and approach paths in each weather preset.
...
| 2. Gust Lance | Beam | 17 | 18 / 1 / 17 | 66t / 190 | 8.79 / 0.27 | impulse=600, move_recovery=30 |
| 3. Jetstream | Lunge | 15 | 8 / 6 / 14 | 66t / 190 | 1.37 / 0.63 | speed=500, move_recovery=25 |
| 4. Updraft | Nova | 16 | 14 / 2 / 15 | 75t / 170 | 0.00 / 2.73 | impulse=450, haste=45, move_recovery=30 |
...
**Locomotion:** turns 150 degrees/s; strafe 50%; reverse 32%; acceleration divisor 4; braking divisor 2; dodge speed 90%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Blood Horn | Melee | 19 | 6 / 3 / 9 | 27t / 60 | 1.76 / 0.78 | health_cost=4, move_start=35, move_active=35, move_recovery=60 |
| 2. Cinder Charge | Lunge | 22 | 8 / 7 / 14 | 66t / 190 | 1.37 / 0.63 | speed=380, impulse=400, health_cost=6, move_recovery=25 |
| 3. Fury | Ward | 0 | 3 / 1 / 9 | 120t / 160 | 0.00 / 0.00 | haste=75, health_cost=5, move_recovery=30 |
| 4. Last Ember | Nova | 21 | 18 / 2 / 15 | 75t / 170 | 0.00 / 2.73 | heal=6, execute=14, move_recovery=30 |
...
**Locomotion:** turns 330 degrees/s; strafe 85%; reverse 65%; acceleration divisor 2; braking divisor 1; dodge speed 100%.
...
**Locomotion:** turns 180 degrees/s; strafe 72%; reverse 55%; acceleration divisor 3; braking divisor 1; dodge speed 90%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Wax Glob | Bolt | 11 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=330, slow=24, move_recovery=30 |
| 2. Candle Sentry | Turret | 7 | 18 / 1 / 15 | 180t / 260 | 3.91 / 0.57 | speed=310, lifetime=240, move_recovery=30, pulse every 27t |
| 3. Hot Seal | Field | 4 | 15 / 1 / 14 | 105t / 210 | 3.71 / 1.76 | lifetime=150, move_recovery=30, pulse every 24t |
| 4. Wax Jacket | Ward | 0 | 3 / 1 / 9 | 120t / 160 | 0.00 / 0.00 | shield=22, guard=18, move_recovery=30 |
...
**Locomotion:** turns 510 degrees/s; strafe 100%; reverse 80%; acceleration divisor 2; braking divisor 1; dodge speed 115%.
...
| 3. Acrobat | Lunge | 13 | 8 / 5 / 14 | 66t / 190 | 1.37 / 0.63 | speed=420, haste=30, move_recovery=25 |
...
**Locomotion:** turns 120 degrees/s; strafe 90%; reverse 40%; acceleration divisor 4; braking divisor 2; dodge speed 85%.
...
**Locomotion:** turns 480 degrees/s; strafe 100%; reverse 75%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
**Locomotion:** turns 150 degrees/s; strafe 52%; reverse 35%; acceleration divisor 4; braking divisor 2; dodge speed 85%.
...
**Locomotion:** turns 90 degrees/s; strafe 45%; reverse 30%; acceleration divisor 5; braking divisor 2; dodge speed 80%.
...
**Locomotion:** turns 420 degrees/s; strafe 90%; reverse 75%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
**Locomotion:** turns 210 degrees/s; strafe 75%; reverse 55%; acceleration divisor 3; braking divisor 2; dodge speed 95%.
...
| 3. Tangle Bed | Field | 3 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | lifetime=150, root=9, move_recovery=30, pulse every 30t |
...
**Locomotion:** turns 180 degrees/s; strafe 58%; reverse 38%; acceleration divisor 3; braking divisor 1; dodge speed 90%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Heat Lance | Beam | 21 | 20 / 1 / 17 | 66t / 190 | 10.74 / 0.27 | move_recovery=30 |
| 2. Coal Fan | Bolt | 8 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=430, burn=45, move_recovery=30, shots=3 |
| 3. Furnace | Field | 5 | 15 / 1 / 14 | 105t / 210 | 4.69 / 2.05 | burn=30, lifetime=150, move_recovery=30, pulse every 24t |
| 4. Vent | Nova | 14 | 14 / 2 / 15 | 75t / 170 | 0.00 / 2.73 | impulse=500, cleanse=1, move_recovery=30 |
...
**Locomotion:** turns 210 degrees/s; strafe 70%; reverse 55%; acceleration divisor 3; braking divisor 1; dodge speed 90%.
...
**Locomotion:** turns 390 degrees/s; strafe 95%; reverse 75%; acceleration divisor 2; braking divisor 1; dodge speed 110%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Copper Ping | Bolt | 13 | 10 / 1 / 11 | 24t / 70 | 11.23 / 0.20 | speed=430, move_start=80, move_active=80, move_recovery=60 |
| 2. Coil Cannon | Beam | 29 | 18 / 1 / 17 | 69t / 260 | 10.74 / 0.27 | move_recovery=30 |
| 3. Springwire | Lunge | 17 | 8 / 7 / 14 | 66t / 210 | 1.37 / 0.63 | speed=380, move_recovery=25 |
| 4. Capacitor | Ward | 0 | 3 / 1 / 9 | 120t / 130 | 0.00 / 0.00 | shield=20, guard=12, move_recovery=30 |
...
| 3. Orchard | Field | 3 | 15 / 1 / 14 | 105t / 210 | 4.69 / 1.76 | lifetime=120, slow=15, move_recovery=30, pulse every 24t |
...
**Locomotion:** turns 270 degrees/s; strafe 85%; reverse 65%; acceleration divisor 3; braking divisor 1; dodge speed 100%.
...
| 4. Takeoff | Blink | 0 | 8 / 1 / 13 | 135t / 230 | 2.93 / 0.00 | move_recovery=25 |
...
**Locomotion:** turns 120 degrees/s; strafe 45%; reverse 30%; acceleration divisor 5; braking divisor 2; dodge speed 80%.
...
| Slot / move | Form | Damage | Startup / active / recovery | CD / stamina | Range / radius | Effects |
|---|---|---:|---|---|---|---|
| 1. Dew Dart | Bolt | 14 | 10 / 1 / 11 | 36t / 130 | 11.23 / 0.20 | speed=470, move_start=75, move_active=75, move_recovery=60 |
| 2. River Cut | Melee | 16 | 6 / 3 / 9 | 27t / 90 | 1.76 / 0.78 | slow=20, move_start=35, move_active=35, move_recovery=60 |
| 3. Waterwheel | Nova | 15 | 14 / 2 / 15 | 75t / 170 | 0.00 / 2.73 | impulse=350, move_recovery=30 |
| 4. Fresh Spring | Ward | 0 | 3 / 1 / 9 | 180t / 160 | 0.00 / 0.00 | shield=10, heal=9, guard=24, cleanse=1, move_recovery=30 |
...
**Locomotion:** turns 330 degrees/s; strafe 85%; reverse 65%; acceleration divisor 2; braking divisor 1; dodge speed 105%.
...
**Locomotion:** turns 300 degrees/s; strafe 90%; reverse 65%; acceleration divisor 3; braking divisor 1; dodge speed 105%.
...
**Locomotion:** turns 120 degrees/s; strafe 45%; reverse 30%; acceleration divisor 4; braking divisor 1; dodge speed 80%.
