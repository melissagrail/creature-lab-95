...
## Actor tensor v3: 2,638 floats

| Slice | Shape | Meaning |
|---|---|---|
| 0:64 | self[64] | Body, resources, cooldowns, statuses, passive meter/counter, physical attributes, axes |
| 64:2184 | entities[53,40] | Enemy, four rock slots, 32 projectile slots, 16 zone slots |
| 2184:2384 | moves[5,40] | Semantic descriptors of the creature's four moves and shared dodge |
| 2384:2424 | announced[40] | Enemy's current move descriptor; zeros while idle |
| 2424:2616 | history[24,8] | Recent public events, newest first, masked padding |
| 2616:2632 | global[16] | Weather, terrain layout, time, objective/control and ending state |
| 2632:2638 | mask[6] | No-op plus five legal-action indicators |
