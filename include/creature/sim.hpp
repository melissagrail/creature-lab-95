...
struct Move {
    const char *name;
    int32_t kind, startup, active, recovery, cooldown, cost;
...
struct Projectile {
    Vec pos{}, vel{};
    int32_t life = 0, owner = 0, move = 1;
};
struct Zone {
    Vec pos{};
    int32_t life = 0, owner = 0, move = 3, age = 0;
};
struct Obstacle {
    Vec pos{};
    int32_t radius = Q;
...
struct World {
    uint32_t rng = 1;
    int32_t tick = 0, terminal = 0, truncated = 0, winner = -1;
...
struct Features {
    int32_t dealt = 0, taken = 0, dodged = 0, interrupts = 0, ko = 0, death = 0;
};
struct StepResult {
...
constexpr int SelfSize = 24, EntityCount = 27, EntitySize = 16, MoveSize = 16, EventSize = 8,
              EventCount = 16, GlobalSize = 8;
struct Observation {
